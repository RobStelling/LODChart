var margin = { top: 20, right: 120, bottom: 20, left: 120 }, width = 950 - margin.right - margin.left, height = 950 - margin.top - margin.bottom;
var index = 0, duration = 750, depth = 70, root, groups = [];
